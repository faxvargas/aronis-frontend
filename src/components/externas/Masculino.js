...
export default function Masculino() {
  ...
  <div class="max-w-7xl mx-auto px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48">
    ...
    <h1 class="mt-2 text-4xl font-extrabold text-white tracking-tight sm:text-5xl">Estamos trabajando en este ambiente</h1>
    <p class="mt-2 text-lg font-medium text-black text-opacity-50">¡En cuanto produzcamos ropa masculina le avisaremos!</p>
    <div class="mt-6">
      <Link to="/" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-black text-opacity-75 bg-white bg-opacity-75 sm:bg-opacity-25 sm:hover:bg-opacity-50">
        Go back home
      </Link>
    </div>
  </div>
